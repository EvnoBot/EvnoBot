...
client.login('token')//the bot 'token' or process.env.token

//.replit
/*
language = "nodejs"
run = "npx node@latest index.js"
*/
```

<!---
EvnoBot/EvnoBot is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
